...
* [Accessibility](./docs/tests/google-lighthouse-based.md)
* [Website performance](./docs/tests/google-lighthouse-based.md)
* [Web Best practice](./docs/tests/google-lighthouse-based.md)
* [Progressive web apps](./docs/tests/google-lighthouse-based.md)
* [SEO best practise](./docs/tests/google-lighthouse-based.md)
