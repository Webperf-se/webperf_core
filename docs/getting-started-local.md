...
## Customization
If you want to change any settings from default you need to copy `SAMPLE-config.py` to new file named `config.py`, [read more about config.py here](config-py.md)