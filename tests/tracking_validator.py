...
def rate_cookies(content, url, local_translation, global_translation):
    ...
    if cookies_number_of_thirdparties > 0:
        ...
        nof_rating = Rating(global_translation, get_config_or_default('review_show_improvements_only'))
    ...
    if cookies_number_of_valid_over_1year > 0:
        ...
        valid_1year_rating = Rating(global_translation, get_config_or_default('review_show_improvements_only'))
        ...
        valid_9months_rating = Rating(global_translation, get_config_or_default('review_show_improvements_only'))
        ...
        valid_6months_rating = Rating(global_translation, get_config_or_default('review_show_improvements_only'))
        ...
        valid_3months_rating = Rating(global_translation, get_config_or_default('review_show_improvements_only'))
    ...
    if cookies_number_of_secure > 0:
        ...
        secure_rating = Rating(global_translation, get_config_or_default('review_show_improvements_only'))
    ...
    if cookies_number_of_analytics > 0:
        ...
        analytics_rating = Rating(global_translation, get_config_or_default('review_show_improvements_only'))
    ...
    result_rating = Rating(global_translation, get_config_or_default('review_show_improvements_only'))
...
def rate_tracking(website_urls, local_translation, global_translation):
    ...
    for website_url, website_url_content in website_urls.items():
        ...
        url_rating = Rating(global_translation, get_config_or_default('review_show_improvements_only'))
        if url_is_tracker:
            request_friendly_name = get_friendly_url_name(global_translation,
